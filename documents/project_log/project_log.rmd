...
panels on a gae only available in development version. Have installed dev version.
...
* Incidences:
*     With the large tidy dataset (over a million rows), spending time on 
*   nailing the queries to return as small a set of data as possible before 
* trying plotting