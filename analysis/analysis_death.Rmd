...
However, the degree of reduction is gradual and isn't as high as for other causes.

Other good news relating to other causes us the impressive reductions in death from circulatory/heart/cerebrovasular (usually strokes). This should serve as 
an inspiring example of improved emphasis on preventative work treating things
like e.g. High Blood Pressure with medication and paramedics being able to administer clot-busting drugs in emergencies reduced the death toll. If so, 
that would be an encouraging example that change is possible when better treatments become available.
