...
plot_death_rate
ggsave(here::here(plot_death_cause_simple_plot_filepath), 
       plot_death_rate)
```
...
Cancer accounts for almost exactly a quarter of all deaths.

#### Change over time for all causes
...
Cancer is the 3rd bar from the top outlined in black. A dotted red vertical line 
