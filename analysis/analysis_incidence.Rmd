...
### Top 10 incidences by Cancer Site and Age Grroup
This is a list of those cancer sites and age groups most at risk of having 
a new cancer diagnosed.

```{r}
table_age_range <- incidences_all_cancer_site_age_range %>%
  ...
  ungroup() %>%
  slice_max(mean_cancer_site_incidences, n = 10) %>%
  select(-mean_cancer_site_incidences)

table_incidences_cancer_sites_age_range(table_age_range)
rm(table_age_range)
``` 
